...
```text
        ...
        │                                                      │
        │  tools/list  ─► moleculeToolDescriptors (26 schemas) │
...
### Tool surface: 26 advertised, `doctor` is CLI-only

`moleculeToolDescriptors` advertises 26 tools. `toolHandlers` defines 27
