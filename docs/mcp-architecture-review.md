...
```text
        ...
        │                                                      │
        │  tools/list  ─► moleculeToolDescriptors (22 schemas) │
...
### Tool surface: 22 advertised, `doctor` is CLI-only

`moleculeToolDescriptors` advertises 22 tools. `toolHandlers` defines 23
