...
- W3 `simulate_assembly` is restriction-ligation only. Use
  `docs/simulate-assembly-spec.md` for remaining hardening or follow-on work.
  Gibson, Golden Gate, Gateway, and In-Fusion remain later scope.
