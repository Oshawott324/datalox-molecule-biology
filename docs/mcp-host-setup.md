...
The server advertises itself as `@datalox/molecule-biology` and exposes 19 tools
...
1. **`tools/list`** — expect 19 tools (`open_sequence`, `open_workspace`,
   ...
   `export_genbank`, `render_plasmid_map`).
